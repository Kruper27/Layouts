    ...
    render() {
        return (
            <div className="prof_out">
                <div className="title">
                    <h2><b> Professional Outsource Website Development Company </b></h2>
                    <p>Enjoy the work with the high-quality experts in web development</p>
                </div>
                <div className="prof_content">
                    <p><span> SmartExe </span> software and web development company have 14 years' experience behind,
                        we`ve performed
